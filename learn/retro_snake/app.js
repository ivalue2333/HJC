...
function Snake() {
    ...
    //画出4个方块，设置成灰色
    for (var i = 0; i < 4; i++) {
        var rect = new Rect(i * rect_length, 0, rect_length, rect_length, "gray");
...
function getRandomFood() {
    ...
    while (isOnSnake) {
        ...
        isOnSnake = false;
        var indexX = getNumberInRange(0, canvas.width / rect_length - 1);
        var indexY = getNumberInRange(0, canvas.height / rect_length - 1);
        var rect = new Rect(indexX * rect_length, indexY * rect_length, rect_length, rect_length, "green");
